...
// You must add your Service Name to the following two statements for Cloudant to create a DB.  Change ibmID-DB to you database name
 ...
 if (tr.createDB("dkitay-qvDB", "qvsample")  == null) {console.log("Database qvsample failed creating");}
 if (tr.createDB("dkitay-qvDB", "qvmetering")  == null) {console.log("Database qvmetering failed creating");}
